"""
Django settings for rems_gen3_mediator project.
...
SECRET_KEY = '=$09@xxvis&oj!n!j47qvvqs&byrtm_3$0&w%=5p+p5@=+yjh2'
...
INSTALLED_APPS = [
    ...
    'rems_event_listener.apps.RemsEventListenerConfig'
]
...
ROOT_URLCONF = 'rems_gen3_mediator.urls'
...
WSGI_APPLICATION = 'rems_gen3_mediator.wsgi.application'
...
GEN3_AUTH_CONFIG = json.loads(os.environ['GEN3_AUTH_CONFIG'] or '{}')
